Source Code for PhysiCell traing App fror Cell mechanics hosted on Google Colab

<!---

This repo is a prototype for using Google Colab for running the PhysiCell Training Apps (in lieu of nanoHUB).
